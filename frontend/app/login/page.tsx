  ...
  useEffect(() => {
    ...
    if (errorParam) {
      const errorMessages: { [key: string]: string } = {
        ...
        "storage_failed": "Failed to store login data. Please try again."
      };
      ...
      <div className="flex items-center justify-center p-8 sm:p-12 relative">
        ...
        <div className="w-full max-w-md space-y-10 relative z-10">
          ...
          <p className="text-center text-sm text-muted-foreground font-medium pt-4">
            ...
            <Link href="/sign-in" className="text-primary hover:text-primary/80 font-semibold transition-colors underline-offset-4 hover:underline">
              Create an account
            </Link>
          </p>
        </div>
